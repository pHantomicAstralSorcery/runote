 {{-- Панель инструментов была вставлена сюда из _toolbar.blade.php и модифицирована --}}
  <div class="btn-toolbar mb-2" role="toolbar" id="editorToolbar">
    ...
    <div class="btn-tgl">
      ...
      {{-- Выравнивание и отступы (добавлена кнопка justifyFull) --}}
      <div class="btn-group me-2">
        ...
        <button class="btn btn-outline-secondary btn-sm" data-cmd="justifyFull" title="По ширине"><i class="bi bi-justify"></i></button> {{-- <-- ДОБАВЛЕНО --}}
      ...
      <div class="btn-group me-2">
        ...
        <button class="btn btn-outline-secondary btn-sm" id="createLink" data-cmd="createLink"><i class="bi bi-link-45deg"></i></button>
      ...
      <div class="btn-group">
        ...
        <ul class="dropdown-menu">
          <li><a class="dropdown-item insert-field" href="#" data-type="text">Текстовое поле</a></li>
          <li><a class="dropdown-item insert-field" href="#" data-type="select">Поле-список</a></li>
          <li><a class="dropdown-item insert-field" href="#" data-type="file">Поле-файл</a></li>
        </ul>
      </div>
    </div>
    </div>